...
const Sidebar = () => {
    ...
    return(
            <aside className="sidebar py-5">
                <div className="box">
                    <h3 className="w-full mb-3 text-[16px] font-[500] flex items-center pr-5">Shop by Category
                ...
                <div className="box">
                    <h3 className="w-full mb-3 text-[16px] font-[500] flex items-center pr-5">Availability
                        <Button className="!w-[30px] !h-[30px] !min-w-[30px] !rounded-full ml-auto !text-[#000]" 
                    ...
                    <FormControlLabel control={<Checkbox size="small"/>} label="Not Available (10)" className="w-full" />
                    </div>
                    </Collapse>
                </div>
                ...
                <div className="box mt-3">
                    <h3 className="w-full mb-3 text-[16px] font-[500] flex items-center pr-5">Size
                        <Button className="!w-[30px] !h-[30px] !min-w-[30px] !rounded-full ml-auto !text-[#000]" 
                ...
                <div className="box mt-4">
                    <h3 className="w-full mb-3 text-[16px] font-[500] flex items-center pr-5">Filter By Price
                        </h3>
                        <RangeSlider/>
                ...
                <div className="box mt-4">
                    <h3 className="w-full mb-3 text-[16px] font-[500] flex items-center pr-5">Filter By Rating
                        </h3>
