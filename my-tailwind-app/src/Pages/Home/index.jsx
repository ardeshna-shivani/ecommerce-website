        ...
        <>
            ...
            {/* <section className="py-6">
                <div className="container flex items-center gap-5">
                    <div className="pert1 w-[70%]">
                        <HomeBannerV2/>
                        </div>

                        <div className="pert2 w-[30%] flex items-center justify-between flex-col gap-5">
            ...
            <section className="py-4 pt-2 bg-white">
                <div className="container">
                    <div className="freeShipping  py-4 p-4 border-2 border-[#ff5252] flex items-center 
                    justify-between rounded-md mb-7 w-[80%] m-auto">
            ...
            <section className="py-5 bg-white pt-0 blogSection pb-8">
                <div className="container">
