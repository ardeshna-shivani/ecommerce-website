            ...
            <div className="container">
                <div className="card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10">
                    ...
                    <form className="w-full mt-5" onSubmit={handleSubmit}>
                        ...
                        name="newPassword" onChange={onChangeInput} value={formFields.newPassword} disabled={loading === true ? true : false}/>
                        <Button className="!absolute top-[10px] right-[10px] z-50 !w-[35px] !h-[35px] !min-w-[35px] !rounded-full !text-black" type="submit"
                        ...
                        name="confirmPassword" onChange={onChangeInput} value={formFields.confirmPassword} disabled={loading === true ? true : false}/>
                        <Button className="!absolute top-[10px] right-[10px] z-50 !w-[35px] !h-[35px] !min-w-[35px] !rounded-full !text-black" type="submit"
                        onClick={()=> setIsShowPassword(!isShowPassword2)}>
                            {
                        ...
                        <div className="flex items-center w-full mt-3 mb-3">
                                                        <Button className="btn-org btn-blue w-full flex gap-3" type="submit" disabled={!valideValue}>
                                                            {
                                                                loading === true ? <CircularProgress color="inherit" /> : 'Change Password'
                                                            }
