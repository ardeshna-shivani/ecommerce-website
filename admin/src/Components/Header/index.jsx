...
const Header = () => {
    ...
    return (
        <>
            <header className='w-full h-[auto] pl-64 bg-[#ffff] flex items-center justify-between pr-7 py-2
            shadow-md'>
                <div className="part-1">
                    <Button className='!w-[40px] !h-[40px] !rounded-full !min-w-[40px] !text-[rgba(0,0,0,0.8)] '>
                        <RiMenu2Line className='text-[18px] text-[rgba(0,0,0,0.8)]' /></Button>
                </div>
                ...
                <div className="part-2 w-[40%] flex items-center justify-end gap-5">
...

                    {
                        ...
                        >
                            ...
                            <MenuItem onClick={handleCloseMyAcc} className='flex items-center gap-3'>
                                <IoMdLogOut className='text-[18px]' /> <span className='text-[14px]' onClick={logout}>Sign Out</span>
                            </MenuItem>
                        </Menu>
                    </div>
                        )
                        ...
                        <Button className='btn-blue btn-sm !rounded-full ' onClick={() => history('/sign-up')}>Sign In</Button>
